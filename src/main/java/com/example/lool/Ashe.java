...
public class Ashe implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        build.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                DBUtils.getRunes(first, second, third, fourth, fifth, sixth, spell1, spell2, 7);
                DBUtils.getBuild(first1, second1, third1, fourth1, fifth1, sixth1, 7);
                DBUtils.createImageRunes(first_img,second_img,third_img,fourth_img,fifth_img,sixth_img,spell1_img,spell2_img,7);
                DBUtils.createImageItems(first_img1,second_img1,third_img1,fourth_img1,fifth_img1,sixth_img1,7);
        ...
        original_ahri.setOnAction(actionEvent -> {
            String url1 = "C:\\Users\\sebir\\LooL\\src\\main\\resources\\Ashe_0.jpg";
            ...
            ratingController.initialize(ahri_hbox, 7, date_ahri,avg);
            date_ahri.setVisible(true);


        });
        dinasty_ahri.setOnAction(actionEvent -> {
            String url12 = "C:\\Users\\sebir\\LooL\\src\\main\\resources\\ashe-lunar-empress-762x.jpg";
        ...
        midnight_ahri.setOnAction(actionEvent -> {
            String url13 = "C:\\Users\\sebir\\LooL\\src\\main\\resources\\ashe-crystalis-motus-762x.jpg";
