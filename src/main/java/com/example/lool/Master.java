    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        build.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                DBUtils.getRunes(first, second, third, fourth, fifth, sixth, spell1, spell2, 9);
                DBUtils.getBuild(first1, second1, third1, fourth1, fifth1, sixth1, 9);
                DBUtils.createImageRunes(first_img,second_img,third_img,fourth_img,fifth_img,sixth_img,spell1_img,spell2_img,9);
                DBUtils.createImageItems(first_img1,second_img1,third_img1,fourth_img1,fifth_img1,sixth_img1,9);
        ...
        original_ahri.setOnAction(actionEvent -> {
            String url1 = "C:\\Users\\sebir\\LooL\\src\\main\\resources\\MasterYi_0.jpg";
            ...
            ratingController.initialize(ahri_hbox, 9, date_ahri,avg);
            date_ahri.setVisible(true);


        });
        dinasty_ahri.setOnAction(actionEvent -> {
            String url12 = "C:\\Users\\sebir\\LooL\\src\\main\\resources\\master-yi-inkshadow-762x.jpg";
        ...
        midnight_ahri.setOnAction(actionEvent -> {
            String url13 = "C:\\Users\\sebir\\LooL\\src\\main\\resources\\master-yi-spirit-blossom-762x.jpg";
