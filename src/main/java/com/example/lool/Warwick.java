...
public class Warwick implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        build.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                DBUtils.getRunes(first, second, third, fourth, fifth, sixth, spell1, spell2, 8);
                DBUtils.getBuild(first1, second1, third1, fourth1, fifth1, sixth1, 8);
                DBUtils.createImageRunes(first_img,second_img,third_img,fourth_img,fifth_img,sixth_img,spell1_img,spell2_img,8);
                DBUtils.createImageItems(first_img1,second_img1,third_img1,fourth_img1,fifth_img1,sixth_img1,8);
        ...
        original_ahri.setOnAction(actionEvent -> {
            String url1 = "C:\\Users\\sebir\\LooL\\src\\main\\resources\\download (9).jpg";
            ...
            ratingController.initialize(ahri_hbox, 8, date_ahri,avg);
            date_ahri.setVisible(true);


        });
        dinasty_ahri.setOnAction(actionEvent -> {
            String url12 = "C:\\Users\\sebir\\LooL\\src\\main\\resources\\warwick-old-god-762x.jpg";
        ...
        midnight_ahri.setOnAction(actionEvent -> {
            String url13 = "C:\\Users\\sebir\\LooL\\src\\main\\resources\\warwick-winterblessed-prestige-762x.jpg";
